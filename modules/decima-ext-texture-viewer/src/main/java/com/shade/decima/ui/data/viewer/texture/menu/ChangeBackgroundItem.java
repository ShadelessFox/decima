...
@MenuItemRegistration(parent = BAR_TEXTURE_VIEWER_ID, name = "Change Background\u2026", description = "Change viewport background", group = BAR_TEXTURE_VIEWER_GROUP_VIEW, order = 1000)
