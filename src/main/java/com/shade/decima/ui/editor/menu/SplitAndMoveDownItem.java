...
@MenuItemRegistration(parent = CTX_MENU_EDITOR_STACK_ID, name = "Split and Move Down", icon = "Editor.splitDownIcon", group = CTX_MENU_EDITOR_STACK_GROUP_SPLIT, order = 2000)
