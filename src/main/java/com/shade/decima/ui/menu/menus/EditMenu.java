...
public interface EditMenu {
    @MenuItemRegistration(parent = APP_MENU_EDIT_ID, keystroke = "ctrl Z", group = APP_MENU_EDIT_GROUP_UNDO, order = 1000)
    ...
    @MenuItemRegistration(parent = APP_MENU_EDIT_ID, keystroke = "ctrl shift Z", group = APP_MENU_EDIT_GROUP_UNDO, order = 2000)
