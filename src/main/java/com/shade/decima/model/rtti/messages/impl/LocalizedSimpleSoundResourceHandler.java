...
@RTTIMessageHandler(type = "LocalizedSimpleSoundResource", message = "MsgReadBinary", game = GameType.DS)
public class LocalizedSimpleSoundResourceHandler implements RTTIMessageReadBinary {
    @Override
