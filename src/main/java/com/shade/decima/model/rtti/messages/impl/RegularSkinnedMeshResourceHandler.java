...
@MessageHandlerRegistration(type = "RegularSkinnedMeshResource", message = "MsgReadBinary", game = GameType.DS)
public class RegularSkinnedMeshResourceHandler implements MessageHandler.ReadBinary {
    @Override
