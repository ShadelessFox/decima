...
[![Support](https://img.shields.io/badge/Support-Buy_Me_A_Coffee-yellow?logo=buymeacoffee&logoColor=white)](https://ko-fi.com/shadelessfox)

# Decima Workshop

Decima Workshop is an open-source modding tool for games powered by [Decima engine](https://en.wikipedia.org/wiki/Decima_(game_engine)). It aims to allow viewing and editing of game files and assets.
